...
head = ("\nBERIKUT DAFTAR BANGUN RUANG YANG KAMI DUKUNG:"
        ...
        "\033[39m"
        f"\n{Style.BRIGHT}MASUKKAN BANGUN DATAR: " f"\33[4mTABUNG")
time.sleep(2)
print(head)
...
while mulai == True:
    ...
    while jalan == True:
        ...
        if bangundatar == "KUBUS":
            ...
            print("LUAS PERMUKAAN BALOK = ", luas_balok, " DENGAN VOLUME = ", volume_balok)
            masih = True
            while masih == True:
                exit_order = input(
                    "\nAPAKAH ANDA INGIN MELANJUTKAN? KETIK 'YES' JIKA IYA DAN 'NO' BILA TIDAK --- ").upper()
            ...
            time.sleep(2)
            print("\nMENGHIUTUNG LUAS PERMUKAAN DAN VOLUME LIMAS SEGIEMPAT")
            ...
            print("LUAS PERMUKAAN LIMAS SEGIEMPAT = ", luas_limas, " DENGAN VOLUME = ", volume_limas)
            masih = True
            while masih == True:
                exit_order = input(
                    "\nAPAKAH ANDA INGIN MELANJUTKAN? KETIK 'YES' JIKA IYA DAN 'NO' BILA TIDAK --- ").upper()
            ...
            print("LUAS PERMUKAAN LIMAS SEGITIGA = ", luas_sisi_ls, " DENGAN VOLUME = ", volume_ls)
            masih = True
            while masih == True:
                exit_order = input(
                    "\nAPAKAH ANDA INGIN MELANJUTKAN? KETIK 'YES' JIKA IYA DAN 'NO' BILA TIDAK --- ").upper()
            ...
            luas_selimut_selinder = 2*22/7*jari_selinder*tinggi_selinder
            volume_selinder = 22/7*jari_selinder*jari_selinder*tinggi_selinder
            luas_permukaan_selinder = 2*22/7*jari_selinder*(jari_selinder+tinggi_selinder)
            hasil_silinder = (f"LUAS SELIMUT SELINDER = {luas_selimut_selinder}"
                              f"DENGAN LUAS PERMUKAAN = {luas_permukaan_selinder}"
                              f"DAN VOLUME = {volume_selinder}")
            ...
            volume_kerucut = 1/3*luas_alas_kerucut*tin
            hasil2 = (f"LUAS SELIMUT KERUCUT = {luas_selimut_kerucut}"
                      f"DENGAN LUAS PERMUKAAN = {luas_permukaan_kerucut}"
                      f"DAN VOLUME = {volume_kerucut}")
            print(hasil2)
            masih = True
            while masih == True:
                exit_order = input(
            ...
            print("LUAS BOLE = ", luas_bola, " DAN VOLUME = ", volume_bola)
            masih = True
            while masih == True:
                exit_order = input(
                    "\nAPAKAH ANDA INGIN MELANJUTKAN? KETIK 'YES' JIKA IYA DAN 'NO' BILA TIDAK --- ").upper()
